...
MOD = {
 "es": {
  ...
  "백은": "de plata blanca", "벼린": "forjada", "벽력": "del trueno",
 ...
 "fr": {
  ...
  "백은": "d’argent blanc", "벼린": "forgée", "벽력": "du tonnerre",
 ...
 "pt": {
  ...
  "백은": "de prata branca", "벼린": "forjada", "벽력": "do trovão",
 ...
 "ru": {
  ...
  "백은": "белого серебра", "벼린": "выкованный", "벽력": "грома",
  ...
  "천공": "небесной тверди", "천륜": "небесного круга", "천문": "созвездий",
 ...
 "id": {
  ...
  "백은": "Perak Putih", "벼린": "Tempaan", "벽력": "Guruh",
 ...
 "vi": {
  ...
  "백은": "bạch ngân", "벼린": "đã rèn", "벽력": "phích lịch",
 ...
 "th": {
  ...
  "백은": "เงินขาว", "벼린": "ตีขึ้นรูป", "벽력": "อสนีบาต",
