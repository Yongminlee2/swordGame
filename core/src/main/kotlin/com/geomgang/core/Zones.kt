...
enum class Zone(
    ...
    ENDLESS_HALL(
        ...
        "회랑 끝의 그림자", 720_000, 5, 5_000_000, 120,
    ),
    SKY_GALLERY(
        ...
        "천공을 걷는 자", 1_600_000, 5, 12_000_000, 160,
    ),
    RUINED_CAPITAL(
        ...
        "잊힌 왕", 4_200_000, 5, 34_000_000, 210,
    ),
    ...
    SILENT_TEMPLE(
        "silent_temple", "침묵의 사원", 27, 1_400_000, 1_100_000,
        listOf(
        ...
        "이름을 잃은 신관", 8_200_000, 5, 66_000_000, 270,
    ),
    GLASS_DESERT(
        "glass_desert", "유리 사막", 28, 3_000_000, 2_400_000,
        listOf(
        ...
        "사막을 걷는 유리왕", 18_000_000, 5, 145_000_000, 340,
    ),
    FLOATING_ISLE(
        "floating_isle", "부유 섬", 29, 4_700_000, 3_700_000,
        listOf(
        ...
        "섬을 든 자", 28_000_000, 5, 225_000_000, 430,
    ),
    WARPED_WOOD(
        "warped_wood", "뒤틀린 숲", 30, 6_800_000, 5_400_000,
        listOf(
        ...
        "뒤틀림의 근원", 41_000_000, 5, 330_000_000, 540,
    ),
    SUNKEN_CITY(
        "sunken_city", "수몰 도시", 31, 10_000_000, 8_000_000,
        listOf(
        ...
        "도시를 삼킨 것", 62_000_000, 5, 500_000_000, 680,
    ),
    ASH_PLAIN(
        "ash_plain", "재의 평원", 32, 15_000_000, 12_000_000,
        listOf(
        ...
        "재를 뿌리는 자", 93_000_000, 5, 750_000_000, 850,
    ),
    STAR_TOMB(
        "star_tomb", "별의 무덤", 33, 23_000_000, 18_000_000,
        listOf(
        ...
        "별을 삼킨 무덤", 140_000_000, 5, 1_120_000_000, 1_060,
    ),
    TIME_RIFT(
        "time_rift", "시간의 균열", 34, 35_000_000, 28_000_000,
        listOf(
        ...
        "균열 너머의 것", 210_000_000, 5, 1_700_000_000, 1_330,
    ),
    BLOOD_KEEP(
        "blood_keep", "피의 성채", 35, 52_000_000, 42_000_000,
        listOf(
        ...
        "피의 군주", 314_000_000, 5, 2_500_000_000, 1_660,
    ),
    FROST_HEART(
        "frost_heart", "서리 심장", 36, 78_000_000, 62_000_000,
        listOf(
        ...
        "심장을 얼린 것", 470_000_000, 5, 3_800_000_000, 2_080,
    ),
    FIRST_FORGE(
        "first_forge", "태초의 대장간", 37, 118_000_000, 94_000_000,
        listOf(
        ...
        "태초의 대장장이", 707_000_000, 5, 5_700_000_000, 2_600,
    ),
    FINAL_GATE(
        "final_gate", "끝의 문", 38, 176_000_000, 140_000_000,
        listOf(
        ...
        "문을 여는 자", 1_060_000_000, 5, 8_500_000_000, 3_250,
    ),
    ;
