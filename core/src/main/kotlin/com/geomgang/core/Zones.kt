...
enum class Zone(
    ...
    MEADOW(
        ...
        "들개 우두머리", 96_300, 5, 160_000, 6,
    ),
    FOREST(
        "forest", "숲", 18, 39_400, 8_900,
        listOf(
        ...
        "거대 멧돼지", 319_000, 5, 473_000, 9,
    ),
    CAVE(
        "cave", "동굴", 20, 91_900, 16_500,
        listOf(
        ...
        "굴의 파수꾼", 722_000, 5, 1_020_000, 14,
    ),
    MINE(
        "mine", "폐광", 22, 227_000, 34_200,
        listOf(
        ...
        "무너진 갱도의 주인", 1_620_000, 5, 2_150_000, 18,
    ),
    SWAMP(
        "swamp", "늪지", 24, 481_000, 75_700,
        listOf(
        ...
        "늪을 삼킨 것", 3_630_000, 5, 4_470_000, 24,
    ),
    VOLCANO(
        "volcano", "화산", 27, 1_400_000, 247_000,
        listOf(
        ...
        "화산의 군주", 12_200_000, 5, 13_400_000, 32,
    ),
    SNOWFIELD(
        "snowfield", "설원", 29, 3_240_000, 526_000,
        listOf(
        ...
        "설원의 백룡", 27_500_000, 5, 28_900_000, 42,
    ),
    DRAGON_NEST(
        "dragon_nest", "용의 둥지", 31, 7_440_000, 1_100_000,
        listOf(
        ...
        "늙은 흑룡", 61_300_000, 5, 60_100_000, 60,
    ),
    ABYSS(
        "abyss", "심연", 33, 18_300_000, 2_230_000,
        listOf(
        ...
        "심연의 왕", 140_000_000, 5, 126_000_000, 84,
    ),
    ENDLESS_HALL(
        "endless_hall", "무한 회랑", 35, 48_100_000, 4_470_000,
        listOf(
        ...
        "회랑 끝의 그림자", 315_000_000, 5, 262_000_000, 120,
    ),
    SKY_GALLERY(
        "sky_gallery", "천공 회랑", 37, 122_000_000, 9_740_000,
        listOf(
        ...
        "천공을 걷는 자", 700_000_000, 5, 552_000_000, 160,
    ),
    RUINED_CAPITAL(
        "ruined_capital", "폐허 왕도", 41, 315_000_000, 42_000_000,
        listOf(
        ...
        "잊힌 왕", 1_830_000_000, 5, 2_490_000_000, 210,
    ),
    ...
    SILENT_TEMPLE(
        "silent_temple", "침묵의 사원", 42, 613_000_000, 60_100_000,
        listOf(
        ...
        "이름을 잃은 신관", 3_590_000_000, 5, 3_680_000_000, 270,
    ),
    GLASS_DESERT(
        "glass_desert", "유리 사막", 43, 1_310_000_000, 86_500_000,
        listOf(
        ...
        "사막을 걷는 유리왕", 7_880_000_000, 5, 5_260_000_000, 340,
    ),
    FLOATING_ISLE(
        "floating_isle", "부유 섬", 44, 2_050_000_000, 126_000_000,
        listOf(
        ...
        "섬을 든 자", 12_200_000_000, 5, 7_570_000_000, 430,
    ),
    WARPED_WOOD(
        "warped_wood", "뒤틀린 숲", 45, 2_970_000_000, 181_000_000,
        listOf(
        ...
        "뒤틀림의 근원", 17_900_000_000, 5, 11_000_000_000, 540,
    ),
    SUNKEN_CITY(
        "sunken_city", "수몰 도시", 46, 4_370_000_000, 257_000_000,
        listOf(
        ...
        "도시를 삼킨 것", 27_100_000_000, 5, 16_000_000_000, 680,
    ),
    ASH_PLAIN(
        "ash_plain", "재의 평원", 47, 6_560_000_000, 368_000_000,
        listOf(
        ...
        "재를 뿌리는 자", 40_700_000_000, 5, 23_300_000_000, 850,
    ),
    STAR_TOMB(
        "star_tomb", "별의 무덤", 48, 10_000_000_000, 552_000_000,
        listOf(
        ...
        "별을 삼킨 무덤", 61_300_000_000, 5, 34_200_000_000, 1_060,
    ),
    TIME_RIFT(
        "time_rift", "시간의 균열", 49, 15_300_000_000, 811_000_000,
        listOf(
        ...
        "균열 너머의 것", 91_900_000_000, 5, 49_900_000_000, 1_330,
    ),
    BLOOD_KEEP(
        "blood_keep", "피의 성채", 50, 22_700_000_000, 1_180_000_000,
        listOf(
        ...
        "피의 군주", 137_000_000_000, 5, 70_900_000_000, 1_660,
    ),
    FROST_HEART(
        "frost_heart", "서리 심장", 51, 34_100_000_000, 1_680_000_000,
        listOf(
        ...
        "심장을 얼린 것", 205_000_000_000, 5, 102_000_000_000, 2_080,
    ),
    FIRST_FORGE(
        "first_forge", "태초의 대장간", 52, 51_600_000_000, 2_440_000_000,
        listOf(
        ...
        "태초의 대장장이", 309_000_000_000, 5, 149_000_000_000, 2_600,
    ),
    FINAL_GATE(
        "final_gate", "끝의 문", 53, 77_000_000_000, 3_680_000_000,
        listOf(
        ...
        "문을 여는 자", 464_000_000_000, 5, 215_000_000_000, 3_250,
    ),
    ;
