...
enum class FamilyStyle(
    ...
    BALANCED(1.0, 1, 150, 0.0, 1.0, 1.0, 0.0, "균형형"),
    COMBO(0.9, 1, 140, 0.03, 1.0, 1.0, 0.0, "연타 시 강화"),
    HEAVY(2.1, 1, 380, 0.0, 1.0, 1.0, 0.0, "느린 강타"),
    SWIFT(0.6, 1, 80, 0.0, 1.0, 1.0, 0.0, "고속 공격"),
    ...
    ELEMENTAL(0.7, 1, 130, 0.04, 1.0, 1.0, 0.12, "연타 · 화상"),
    OMNI(0.9, 1, 150, 0.02, 1.25, 1.25, 0.0, "전 특성 혼합"),
    HOLLOW(
        0.5, 1, 150, 0.0, 1.0, 1.0, 0.0, "최대 체력 비례 피해",
        maxHpRatio = 0.015,
    ),
    ;
